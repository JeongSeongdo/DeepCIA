...
TN='D:\Version_5_Train_set';
VN='D:\Version_5_Validation_set';
...
Network_5 = trainNetwork(dsTrain,lgraph,options);

%%% Assessment of accuracy, precision, recall, and F1 scores for the train and validation sets of the fifth network%%%
% [YPred,probs] = classify(Network_5,dsTrain);
% accuracy_test = mean(YPred == imds_Train.Labels);
% confMat = confusionmat(imds_Train.Labels,YPred);
[YPred,probs] = classify(Network_5,dsVal);
...
[YPred,probs] = classify(Network_5,dsTest);
